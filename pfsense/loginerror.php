...
<body>
        ...
        <div class="card">
          <div class="login-box">
            <div class="login-snip">
              ...
              <div class="check">
                <input type="hidden" value="$PORTAL_MESSAGE$" id="error_message"><br>                
                <div id="error"></div>
                ...
                <div class=" login">
                  <div class="group" style="padding-left: 15px;">
                    <label for="auth_user" class="label" style="display: block; padding-left: 5px;">Identifiant</label>
                    <input id="user" name="auth_user" type="text" class="input" placeholder="Enter your username" style="width: 80%;">
                  </div>
                  <div class="group" style="padding-left: 15px;">
                    <label for="auth_pass" class="label">Mot de passe</label>
  ...
  <script>
    const error_input = document.getElementById('error_message');
    const errorDiv = document.getElementById('error');

    errorDiv.innerHTML = error_input.value;
